...
export default function ColumnFilter(props: { column: Column<any, unknown>; table: Table<any> }) {
      ...
      fallback={
        <div>
          ...
          <input
            ...
            onInput={debounce((e) => props.column.setFilterValue(e.target.value), 500)}
      ...
      <div>
        <div class="flex space-x-2">
          <input
            ...
            onInput={debounce(
              (e) =>
                props.column.setFilterValue((old: [number, number]) => [e.target.value, old?.[1]]),
              500,
            )}
            placeholder={`Min ${
          ...
          <input
            ...
            onInput={debounce(
              (e) =>
                props.column.setFilterValue((old: [number, number]) => [old?.[0], e.target.value]),
              500,
            )}
            placeholder={`Max ${
